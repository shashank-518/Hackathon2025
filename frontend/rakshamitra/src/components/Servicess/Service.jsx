...
const Service = () => {
  return (
    <div className='servicediv' id='#service'>
      ...
      <Card name ="Ambulance" img = "https://img.freepik.com/premium-vector/ambulance-car-icon-clipart-avatar-logotype-isolated-vector-illustration_955346-110.jpg" item1=" Seva AI"   />
